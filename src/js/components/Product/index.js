        ...
        <div key={id} className="product row">
          ...
          <div className="product-details col-xs-12 col-sm-6 col-lg-4">
            ...
            <div
              ...
              <div>{dollars}.{cents} {currentSku.currency.toUpperCase()}</div>
              <div className="product-taxes">included</div>
            </div>
            ...
            {currentSku.attributes ?
                <div className="product-selected-size">
                  size: {currentSku.attributes.size} |
                  Stock: {currentSku.inventory.quantity} Left
                </div> : null}
          </div>
        </div>
    );
