...
import "../../../CSS/components/PayButton/PayButton.css";
          ...
          {alreadyOrdered ?
              ...
              <div>
                {addedToBasket ? null : <button
                        ...
                        className="btn btn-primary btn-block paybutton-add-to-basket">Add to shopping cart</button>}
                    ...
                    <form onSubmit={(ev) => this.openStripe(ev)}>
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-group col-md-4">
                          <input type="text" className="form-control"
                                 id="inputStreetNumber" placeholder="Street Number"
                                 name="streetNumber"
                                 onChange={this.handleInputChange}
                                 onBlur={this.handleInputChange}/>
                        </div>
